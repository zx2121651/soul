...
# Define massive comprehensive schema creation logic
massive_schema = """
...
# Replace the old basic table creation with the massive schema
content = re.sub(r"  // Create Users Table[\s\S]*?// Seed Data \(if empty\)", massive_schema + "\n  // Seed Data (if empty)\n", content)

# Make sure wallet gets seeded for the default user
seed_wallet = """
    ...
    `, [userId, 1000, 50]);
"""
content = content.replace("console.log('Database seeding complete.');", seed_wallet + "\n    console.log('Database seeding complete.');")
