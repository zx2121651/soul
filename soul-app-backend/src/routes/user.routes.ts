...
router.put('/me/profile', (req, res) => sendSuccess(res, { success: true, message: '个人资料已更新', updatedData: req.body }));

// --- User Relationship (Mock Implementation) ---
router.post('/:id/follow', (req, res) => sendSuccess(res, { success: true, message: 'Followed' }));
router.post('/:id/unfollow', (req, res) => sendSuccess(res, { success: true, message: 'Unfollowed' }));
...
router.post('/:id/block', (req, res) => sendSuccess(res, { success: true, message: 'User blocked' }));
router.post('/:id/unblock', (req, res) => sendSuccess(res, { success: true, message: 'User unblocked' }));
router.get('/blocked', (req, res) => sendSuccess(res, { blockedUsers: [] }));
router.post('/:id/report', (req, res) => sendSuccess(res, { success: true, message: 'Report submitted successfully' }));
